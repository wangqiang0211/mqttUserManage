$(function () {
    ...
    function zic_msg(data) {
        ...
        if("c"==jsonType){
            ...
            times();
            var listSize = "<li ><div class='clearfix'><p class='fl zic_deviceUid'>" + jsonFromDevice + "</p><p class='fl zic_time'>" + currentdate + "</p></div><div class='clearfix'><p class='pimg fl'><img src='../dist/img/zic.png' /></p><p class='fl zicsart_texts'>" + jsonData + "</p></div></li>";
    ...
    $(document).on("click", ".data_sub", function () {
        ...
        if (dataInput == "" || dataInput == null) {
            ...
            var list = "<li><div class='clearfix'><p class='fl zic_deviceUid'>" + respObj.deviceName + "</p><p class='fl zic_time'>" + currentdate + "</p></div><div class='clearfix'><p class='pimg fr'><img src='../dist/img/zic.png' /></p><p class='fl zicsart_text'>" + dataInput + "</p></div></li>";
