...
import com.cdzic.mqttUserManage.dao.repo.sys.SysUserRepo;
...
import com.cdzic.mqttUserManage.domain.vo.sys.SysPermissionCVO;
import com.cdzic.mqttUserManage.domain.vo.sys.SysRoleCVO;
import com.cdzic.mqttUserManage.domain.vo.sys.SysUserCVO;
...
//    private SeccondLevelRepo seccondLevelRepo;
     ...
     * @return
     */
    @ApiOperation(value = "权限查询/搜索", notes = "权限查询/搜索")
     ...
     * @return
     */
    @ApiOperation(value = "角色查询/搜索", notes = "角色查询/搜索")
...
//        System.out.println(roleList.size()+"查看查询的角色长度!");
     ...
     * @return
     */
    @ApiOperation(value = "管理员查询/搜索", notes = "管理员查询/搜索")
     ...
     * @return
     */
    @ApiOperation(value = "停用管理员", notes = "停用管理员")
